...
**Policy alignment:** `.Codex/cursor.rules` is the concise policy baseline; this file is the implementation guide.
...
**`[AMENDED 2026-06-18]:`** Roster is now **49 skills**; **28** idle-trainable via `SkillDataRegistry`; **Resonance** = 5th-tab clicker. See `DOCS/SUMMARY.md` → Live Product Snapshot.
...
> These come from `.Codex/cursor.rules` — they apply to all doc edits.
